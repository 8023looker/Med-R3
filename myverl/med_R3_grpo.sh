...
if [ "$master_ip" = "$curr_ip" ]; then
    ...
    ray job submit \
        ...
        -- python -u -m verl.trainer.main_ppo \
            ...
            data.train_files=./myverl/data/train/merged_med-multi_sample.parquet \
            data.val_files=./myverl/data/train/merged_med-multi_sample.parquet \
            data.train_batch_size=256 \
            data.max_prompt_length=2048 \
            data.max_response_length=14336 \
            data.truncation=left \
            data.reward_fn_key=reward_actor \
            actor_rollout_ref.model.path=./model/Qwen2d5-7B \
