...
RUN_NAME=Qwen2.5-7B_ppo_from_base_0503

export WANDB_API_KEY="xxx"
export WANDB_ENTITY="xxx"
export WANDB_PROJECT="med-R3"
...
bash my_reward/bgem3_embed_nginx.sh 44000
...
if [ "$master_ip" = "$curr_ip" ]; then
    ...
    ray job submit \
        ...
        -- python -u -m verl.trainer.main_ppo \
            ...
            data.train_files=/global_data/data/medicalRL/code/myverl/data/train/merged_med-multi_sample.parquet \
            data.val_files=/global_data/data/medicalRL/code/myverl/data/train/merged_med-multi_sample.parquet \
            data.train_batch_size=256 \
            data.max_prompt_length=2048 \
            data.max_response_length=14336 \
            data.truncation=left \
            data.reward_fn_key=reward_actor \
            actor_rollout_ref.model.path=/global_data/data/opensource/Qwen2d5-7B \
            ...
            reward_model.reward_manager=diagnosis_with_search \
            ...
            +reward_model.reward_kwargs.api_params.bgem3_embed_url=http://$master_ip:44000/embedding \
