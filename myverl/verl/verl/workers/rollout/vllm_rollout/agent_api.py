...
#     prompt = """
# 给出广东2022年GDP最高的城市名称以及GDP数值，单位亿元
# 以下面的json格式返回
# ```json
# {{
#     "city": ...,
...
#         gdp: float = Field(..., title="GDP", description="GDP")

#     base_model = CityGDP

    # print(f"oneapi_post_by_langchain: {prompt}, {url}, {model}, {key}, {max_tokens}, {temperature}, {top_p}, {max_concurrency}") # for debugging
    ...
    prompt_list = []
    # 如果 system_prompt 是字符串，那么就是所有的 system_prompt 都是一样的
