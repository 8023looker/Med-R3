    ...
    def _build_rollout(self, trust_remote_code=False):
        ...
        if rollout_name == 'hf':
            ...
            if self.config.rollout.name == 'vllm':
                ...
                from verl.workers.rollout.vllm_rollout import vLLMRolloutWithRetrieval, vllm_mode
                rollout_class = vLLMRolloutWithRetrieval
            elif rollout_name == 'vllm_with_agent_stage1': # stage 1
                from verl.workers.rollout.vllm_rollout import vLLMRolloutWithAgent, vllm_mode
                rollout_class = vLLMRolloutWithAgent
            elif rollout_name == 'vllm_with_agent_stage2': # stage 2
                from verl.workers.rollout.vllm_rollout import vLLMRolloutWithAgentStage2, vllm_mode
                rollout_class = vLLMRolloutWithAgentStage2
            else:
